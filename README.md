...
The installation requires macOS with brew.
...
and installation instructions can be found in nvidia.com
...
Note: The above install script will install the following packages via apt-get/brew:
